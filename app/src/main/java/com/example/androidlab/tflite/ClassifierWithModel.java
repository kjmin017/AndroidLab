package com.example.androidlab.tflite;
...
public class ClassifierWithModel {
    private static final String MODEL_NAME = "keras_model_cnn_malware.tflite";
    ...
    public ClassifierWithModel(Context context) { this.context = context;}
    ...
    public Pair<String, Float> classify(Bitmap image) { return classify(image, 0);}
